...
console.log( Object.keys(obj) ); //键 的数组
console.log( Object.values(obj) ); //值 的数组
console.log( Object.entries(obj) ); //键值 的数组
